...
add_action('init', function(){
    register_post_type('property', [
        ...
        'labels' => [
            ...
            'edit_item'                => __('View property' , 'agence'),
    ...
    register_taxonomy('property_type', 'property', [
        ...
        'labels' => [
            ...
            'search_items'               => __('Search Type', 'agence'),
            ...
            'update_item'                => __('Updated Type', 'agence'),
            ...
            'add_or_remove_items'        => __('Add or removes Types', 'agence'),
    ...
    register_taxonomy('property_city', 'property', [
        ...
        'labels' => [
            ...
            'search_items'               => __('Search City', 'agence'),
            ...
            'update_item'                => __('Updated City', 'agence'),
            ...
            'add_or_remove_items'        => __('Add or removes Cities', 'agence'),
    ...
    register_taxonomy('property_option', 'property', [
        'labels' => [
            ...
            'search_items'               => __('Search Option', 'agence'),
            ...
            'update_item'                => __('Updated Option', 'agence'),
            ...
            'add_or_remove_items'        => __('Add or removes Options', 'agence'),
