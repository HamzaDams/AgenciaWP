...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div class="container">
        ...
        <section class="bien-options">
            <div class="bien-option"><img src="<?= get_template_directory_uri() ?>/assets/area.78237e19.svg" alt=""> <?= __('Surface', 'agencia') ?> : <?= the_field('surface'); ?>m²</div>
            <div class="bien-option"><img src="<?= get_template_directory_uri() ?>/assets/elevator-fill.117c4510.svg" alt=""> <?= __('Rooms', 'agencia') ?> : <?= the_field('rooms'); ?></div>
            <div class="bien-option"><img src="<?= get_template_directory_uri() ?>/assets/rooms.b02e3d15.svg" alt=""> <?= __('Floor', 'agencia') ?> : <?= the_field('floor'); ?></div>
